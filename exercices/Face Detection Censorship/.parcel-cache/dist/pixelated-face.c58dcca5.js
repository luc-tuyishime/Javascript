...
const SIZE = 10;
const SCALE = 1.5; // write a function that populate the users video
...
function censor({
  ...
  const height = face.height * SCALE; // DRAW the small face back on but scale it

  faceCtx.drawImage(faceCanvas, // source
  face.x, // where do we start the source pull from?
  face.y, SIZE, SIZE, // Drawing args
  face.x, face.y, width, height); // Take that face back and draw it back at normal
}
...
//# sourceMappingURL=pixelated-face.c58dcca5.js.map
