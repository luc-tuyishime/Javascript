...
})({"14c64467bba67f99352c794a767abd97":[function(require,module,exports) {
...
const SIZE = 10; // write a function that populate the users video
...
function censor({
  ...
  face.x, face.y, SIZE, SIZE); // DRAW the small face back on but scale it

  faceCtx.drawImage(faceCanvas, // source
  face.x, face.y, SIZE, SIZE, // Drawing args
  face.x, face.y, face.width, face.height); // Take that face back and draw it back at normal
}
...
},{}]},{},["d347dc37b6ca23899ffbbc32fd87b43f","14c64467bba67f99352c794a767abd97"], null)

//# sourceMappingURL=pixelated-face.c2294132.js.map
